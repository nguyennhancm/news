...
!function () {
    ...
    return i = a(), k = i && qq.isXhrUploadSupported(), j = k && !qq.androidStock(), l = k && b(), m = k && qq.isFileChunkingSupported(), n = k && m && h(), o = k && c(), p = i && (void 0 !== window.postMessage || k), r = d(), q = e(), s = f(), t = g(), u = k && void 0 !== window.FileReader, v = function () {
        return k ? !qq.androidStock() && !qq.iosChrome() : !1
    }(), {ajaxUploading: k, blobUploading: j, canDetermineSize: k, chunking: m, deleteFileCors: s, deleteFileCorsXdr: q, deleteFileCorsXhr: r, fileDrop: k, folderDrop: l, folderSelection: t, imagePreviews: u, imageValidation: u, itemSizeValidation: k, pause: m, progressBar: v, resume: n, scaling: u && j, tiffPreviews: qq.safari(), unlimitedScaledImageSize: !qq.ios(), uploading: i, uploadCors: p, uploadCustomHeaders: k, uploadNonMultipart: k, uploadViaPaste: o}
    ...
    }, ios8BrowserCrashWorkaround: !0, hoverClass: "qq-upload-button-hover", focusClass: "qq-upload-button-focus"};
    ...
    qq.basePublicApi = {addBlobs: function (a, b, c) {
        ...
        if (size < 1024) {
            ...
            size = Math.floor((size / (1024.0 * 1024.0)) * 100) / 100;
            return size + ' MB';
        } else {
            size = Math.floor((size / (1024.0 * 1024.0 * 1024.0)) * 100) / 100;
            return size + ' GB';
        }
    ...
    var b, c, d, e, f, g, h, i, j = "qq-file-id", k = "qq-file-id-", l = "qq-max-size", m = "qq-server-scale", n = "qq-hide-dropzone", o = !1, p = 0, q = !1, r = [], s = -1, t = {log: null, limits: {maxThumbs: 0, timeBetweenThumbs: 750}, templateIdOrEl: "qq-template", containerEl: null, fileContainerEl: null, button: null, imageGenerator: null, classes: {hide: "qq-hide", editable: "qq-editable"}, placeholders: {waitUntilUpdate: !1, thumbnailNotAvailable: null, waitingForThumbnail: null}, text: {paused: "Paused"}}, u = {button: "qq-upload-button-selector", drop: "qq-upload-drop-area-selector", list: "qq-upload-list-selector", progressBarContainer: "qq-progress-bar-container-selector", progressBar: "qq-progress-bar-selector", totalProgressBarContainer: "qq-total-progress-bar-container-selector", totalProgressBar: "qq-total-progress-bar-selector", file: "qq-upload-file-selector", spinner: "qq-upload-spinner-selector", size: "qq-upload-size-selector", cancel: "qq-upload-cancel-selector", pause: "qq-upload-pause-selector", continueButton: "qq-upload-continue-selector", deleteButton: "qq-upload-delete-selector", retry: "qq-upload-retry-selector", statusText: "qq-upload-status-text-selector", editFilenameInput: "qq-edit-filename-selector", editNameIcon: "qq-edit-filename-icon-selector", dropProcessing: "qq-drop-processing-selector", dropProcessingSpinner: "qq-drop-processing-spinner-selector", thumbnail: "qq-thumbnail-selector"}, v = {}, w = new qq.Promise, x = new qq.Promise, y = function () {
        ...
        var e = P(a);
        return b("Generating new thumbnail for " + a), c.qqThumbnailId = a, t.imageGenerator.generate(c, e, d).then(function () {
            p++, Y(e), v[a].success()
        }, function () {
            v[a].failure(), t.placeholders.waitUntilUpdate || S(a, e)
        })
    }, B = function () {
        if (r.length) {
            q = !0;
        ...
        return O(H(a), u.cancel)
    }, D = function (a) {
        return O(H(a), u.continueButton)
    }, E = function (a) {
        return O(H(a), u.deleteButton)
    }, F = function () {
        return O(f, u.dropProcessing)
    }, G = function (a) {
        return O(H(a), u.editNameIcon)
    }, H = function (a) {
        return qq(g).getByClass(k + a)[0]
    }, I = function (a) {
        return O(H(a), u.file)
    }, J = function (a) {
        return O(H(a), u.pause)
    }, K = function (a) {
        return null == a ? O(f, u.totalProgressBarContainer) || O(f, u.totalProgressBar) : O(H(a), u.progressBarContainer) || O(H(a), u.progressBar)
    }, L = function (a) {
        return O(H(a), u.retry)
    }, M = function (a) {
        return O(H(a), u.size)
    }, N = function (a) {
        return O(H(a), u.spinner)
    }, O = function (a, b) {
        return a && qq(a).getByClass(b)[0]
    }, P = function (a) {
        return h && O(H(a), u.thumbnail)
    }, Q = function (a) {
        a && qq(a).addClass(t.classes.hide)
    }, R = function (a, b) {
        var c = a.style.maxWidth, d = a.style.maxHeight;
        d && c && !b.style.maxWidth && !b.style.maxHeight && qq(b).css({maxWidth: c, maxHeight: d})
    }, S = function (a, b) {
        var c = v[a] || (new qq.Promise).failure(), d = new qq.Promise;
        return w.then(function (a) {
            c.then(function () {
                d.success()
            }, function () {
                R(a, b), b.onload = function () {
                    b.onload = null, d.success()
                }, b.src = a.src, Y(b)
            })
        }), d
    }, T = function () {
        var a, e, f, g, j, k, o, p, q;
        if (b("Parsing template"), null == t.templateIdOrEl)throw new Error("You MUST specify either a template element or ID!");
        if (qq.isString(t.templateIdOrEl)) {
            if (a = document.getElementById(t.templateIdOrEl), null === a)throw new Error(qq.format("Cannot find template script at ID '{}'!", t.templateIdOrEl));
            e = a.innerHTML
        } else {
            if (void 0 === t.templateIdOrEl.innerHTML)throw new Error("You have specified an invalid value for the template option!  It must be an ID or an Element.");
            e = t.templateIdOrEl.innerHTML
        }
        if (e = qq.trimStr(e), g = document.createElement("div"), g.appendChild(qq.toElement(e)), t.button && (k = qq(g).getByClass(u.button)[0], k && qq(k).remove()), qq.DragAndDrop && qq.supportedFeatures.fileDrop || (q = qq(g).getByClass(u.dropProcessing)[0], q && qq(q).remove()), o = qq(g).getByClass(u.drop)[0], o && !qq.DragAndDrop && (b("DnD module unavailable.", "info"), qq(o).remove()), o && !qq.supportedFeatures.fileDrop && qq(o).hasAttribute(n) && qq(o).css({display: "none"}), p = qq(g).getByClass(u.thumbnail)[0], h ? p && (s = parseInt(p.getAttribute(l)), s = s > 0 ? s : null, i = qq(p).hasAttribute(m)) : p && qq(p).remove(), h = h && p, c = qq(g).getByClass(u.editFilenameInput).length > 0, d = qq(g).getByClass(u.retry).length > 0, f = qq(g).getByClass(u.list)[0], null == f)throw new Error("Could not find the file list container in the template!");
        return j = f.innerHTML, f.innerHTML = "", b("Template parsing complete"), {template: qq.trimStr(g.innerHTML), fileTemplate: qq.trimStr(j)}
    }, U = function (a, b) {
        var c = g, d = c.firstChild;
        b > 0 && (d = qq(c).children()[b].nextSibling), c.insertBefore(a, d)
    }, V = function (a) {
        var b = a.id, c = a.optFileOrBlob, d = c && c.qqThumbnailId, e = P(b), f = {maxSize: s, scale: !0, orient: !0};
        qq.supportedFeatures.imagePreviews ? e && (t.limits.maxThumbs && t.limits.maxThumbs <= p ? (S(b, e), B()) : z(e).done(function () {
            v[b] = new qq.Promise, v[b].done(function () {
                setTimeout(B, t.limits.timeBetweenThumbs)
            }), null != d ? Z(b, d) : A(b, c, f)
        })) : e && (z(e), B())
    }, W = function (a) {
        var b = a.id, c = a.thumbnailUrl, d = a.showWaitingImg, e = P(b), f = {maxSize: s, scale: i};
        if (e)if (c) {
            if (!(t.limits.maxThumbs && t.limits.maxThumbs <= p))return d && z(e), t.imageGenerator.generate(c, e, f).then(function () {
                Y(e), p++, setTimeout(B, t.limits.timeBetweenThumbs)
            }, function () {
                S(b, e), setTimeout(B, t.limits.timeBetweenThumbs)
            });
            S(b, e), B()
        } else S(b, e), B()
    }, X = function (a, b) {
        var c = K(a), d = null == a ? u.totalProgressBar : u.progressBar;
        c && !qq(c).hasClass(d) && (c = qq(c).getByClass(d)[0]), c && qq(c).css({width: b + "%"})
    }, Y = function (a) {
        a && qq(a).removeClass(t.classes.hide)
    }, Z = function (a, c) {
        var d = P(a), e = P(c);
        b(qq.format("ID {} is the same file as ID {}.  Will use generated thumbnail from ID {} instead.", a, c, c)), v[c].then(function () {
            p++, v[a].success(), b(qq.format("Now using previously generated thumbnail created for ID {} on ID {}.", c, a)), d.src = e.src, Y(d)
        }, function () {
            v[a].failure(), t.placeholders.waitUntilUpdate || S(a, d)
        })
    };
    qq.extend(t, a), b = t.log, qq.supportedFeatures.imagePreviews || (t.limits.timeBetweenThumbs = 0, t.limits.maxThumbs = 0), f = t.containerEl, h = void 0 !== t.imageGenerator, e = T(), y(), qq.extend(this, {render: function () {
        b("Rendering template in DOM."), p = 0, f.innerHTML = e.template, Q(F()), this.hideTotalProgress(), g = t.fileContainerEl || O(f, u.list), b("Template rendering complete")
        ...
        var d, f = qq.toElement(e.fileTemplate), h = O(f, u.file);
        qq(f).addClass(k + a), h && qq(h).setText(b), f.setAttribute(j, a), c ? U(f, c.index) : g.appendChild(f), Q(K(a)), Q(M(a)), Q(E(a)), Q(L(a)), Q(J(a)), Q(D(a)), o && this.hideCancel(a), d = P(a), d && !d.src && x.then(function (a) {
            d.src = a.src, a.style.maxHeight && a.style.maxWidth && qq(d).css({maxHeight: a.style.maxHeight, maxWidth: a.style.maxWidth}), Y(d)
        })
        ...
        var b = I(a);
        b && qq(b).addClass(t.classes.editable)
        ...
        return qq(a).hasClass(u.file)
    }, getButton: function () {
        return t.button || O(f, u.button)
        ...
        var b = G(a);
        b && qq(b).removeClass(t.classes.editable)
    }, isEditIcon: function (a) {
        return qq(a).hasClass(u.editNameIcon)
    }, getEditInput: function (a) {
        return O(H(a), u.editFilenameInput)
    }, isEditInput: function (a) {
        return qq(a).hasClass(u.editFilenameInput)
    }, updateProgress: function (a, b, c) {
        var d, e = K(a);
        e && c > 0 && (d = Math.round(100 * (b / c)), 100 === d ? Q(e) : Y(e), X(a, d))
        ...
        X(a, 0), this.hideTotalProgress(a)
    }, resetTotalProgress: function () {
        this.resetProgress()
    }, showCancel: function (a) {
        if (!o) {
            var b = C(a);
            b && qq(b).removeClass(t.classes.hide)
        }
    }, hideCancel: function (a) {
        Q(C(a))
    }, isCancel: function (a) {
        return qq(a).hasClass(u.cancel)
    }, allowPause: function (a) {
        Y(J(a)), Q(D(a))
    }, uploadPaused: function (a) {
        this.setStatusText(a, t.text.paused), this.allowContinueButton(a), Q(N(a))
    }, hidePause: function (a) {
        Q(J(a))
    }, isPause: function (a) {
        return qq(a).hasClass(u.pause)
    }, isContinueButton: function (a) {
        return qq(a).hasClass(u.continueButton)
    }, allowContinueButton: function (a) {
        Y(D(a)), Q(J(a))
    }, uploadContinued: function (a) {
        this.setStatusText(a, ""), this.allowPause(a), Y(N(a))
    }, showDeleteButton: function (a) {
        Y(E(a))
    }, hideDeleteButton: function (a) {
        Q(E(a))
    }, isDeleteButton: function (a) {
        return qq(a).hasClass(u.deleteButton)
    }, isRetry: function (a) {
        return qq(a).hasClass(u.retry)
    }, updateSize: function (a, b) {
        var c = M(a);
        c && (Y(c), qq(c).setText(b))
    }, setStatusText: function (a, b) {
        var c = O(H(a), u.statusText);
        ...
        r.push({id: a, optFileOrBlob: b}), !q && B()
    }, updateThumbnail: function (a, b, c) {
        r.push({update: !0, id: a, thumbnailUrl: b, showWaitingImg: c}), !q && B()
    }})
