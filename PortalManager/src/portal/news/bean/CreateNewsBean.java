 ...
 */
@SessionScoped
@ManagedBean(name = "CreateNews")
public class CreateNewsBean extends BasePortalBean {
    ...
    public String createNews() {
        if (validateNews(newsData.getNews().getPrimaryProductCategoryId(), newsData.getNews().getProductName(),
            ...
            product.setCreatedByUserLogin(newsManagerBean.getUserData().getUserLogin().getUserLoginId());
