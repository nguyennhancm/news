 ...
 */
@SessionScoped
@ManagedBean(name = "EditNews")
public class EditNewsBean extends BasePortalBean {
    ...
    public String updateNews() {
        if (validateNews(newsData.getNews().getPrimaryProductCategoryId(), newsData.getNews().getProductName(),
            ...
            try {
                newsManagerBean.getNewsController().updateNews(product, newsData.getProductAttributes());
