...
public class ViewPrefType implements Serializable {
    ...
    @Basic
    @Column(name = "APPLICATION", nullable = true, insertable = true, updatable = true, length = 255)
    ...
    @Basic
    @Column(name = "APPLICATION_SECTION", nullable = true, insertable = true, updatable = true, length = 255)
    ...
    @Basic
    @Column(name = "SCREEN_NAME", nullable = true, insertable = true, updatable = true, length = 255)
    ...
    @Basic
    @Column(name = "FORM_NAME", nullable = true, insertable = true, updatable = true, length = 255)
    ...
    @Basic
    @Column(name = "DOM_ID", nullable = true, insertable = true, updatable = true, length = 250)
    ...
    public boolean equals(Object o) {
        ...
        ViewPrefType that = (ViewPrefType) o;

        if (application != null ? !application.equals(that.application) : that.application != null) return false;
        if (applicationSection != null ? !applicationSection.equals(that.applicationSection) : that.applicationSection != null)
            return false;
        ...
        if (domId != null ? !domId.equals(that.domId) : that.domId != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (applicationSection != null ? applicationSection.hashCode() : 0);
        result = 31 * result + (screenName != null ? screenName.hashCode() : 0);
        result = 31 * result + (formName != null ? formName.hashCode() : 0);
        result = 31 * result + (domId != null ? domId.hashCode() : 0);
