...
public class VisualThemeSet implements Serializable{
    ...
    @Id
    @Column(name = "VISUAL_THEME_SET_ID", nullable = false, insertable = true, updatable = true, length = 20)
    ...
    public boolean equals(Object o) {
        ...
        VisualThemeSet that = (VisualThemeSet) o;
        ...
        if (lastUpdatedTxStamp != null ? !lastUpdatedTxStamp.equals(that.lastUpdatedTxStamp) : that.lastUpdatedTxStamp != null)
            return false;
        if (visualThemeSetId != null ? !visualThemeSetId.equals(that.visualThemeSetId) : that.visualThemeSetId != null)
            return false;
    ...
    @Override
    public int hashCode() {
        int result = visualThemeSetId != null ? visualThemeSetId.hashCode() : 0;
