...
public class WebAnalyticsType implements Serializable {
    ...
    private WebAnalyticsType webAnalyticsTypeByParentTypeId;
    ...
    public boolean equals(Object o) {
        ...
        WebAnalyticsType that = (WebAnalyticsType) o;
    ...
    @Override
    public int hashCode() {
        int result = webAnalyticsTypeId != null ? webAnalyticsTypeId.hashCode() : 0;
    ...
    @ManyToOne
    @JoinColumn(name = "PARENT_TYPE_ID", referencedColumnName = "WEB_ANALYTICS_TYPE_ID")
    public WebAnalyticsType getWebAnalyticsTypeByParentTypeId() {
        return webAnalyticsTypeByParentTypeId;
    }

    public void setWebAnalyticsTypeByParentTypeId(WebAnalyticsType webAnalyticsTypeByParentTypeId) {
        this.webAnalyticsTypeByParentTypeId = webAnalyticsTypeByParentTypeId;
    }
}
