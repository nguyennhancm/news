...
jQuery(document).ready(function() {
	...
	if(jQuery(".slider-container")){
		...
		if(_legatus_slider_autostart){
			...
			if(_legatus_slider_loading){
				jQuery(".slider-container .slider-content").append("<div></div>");
				sliderLoading();
			}
		}
	}
	...
	jQuery(".header .header-menu").find("ul.main-menu").addClass("load-responsive").attr("rel", "Chuyên mục").parent().parent().siblings(".header-undermenu");
