...
jQuery(document).ready(function() {
	...
	jQuery(".header .header-menu").find("ul.main-menu").addClass("load-responsive").attr("rel", "Chuyên mục").parent().parent().siblings(".header-undermenu").find("ul.secondary-menu");
