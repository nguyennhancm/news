...
//    private VisualThemeSet visualThemeSetByVisualThemeSetId;
    ...
    @Basic
    @Column(name = "PRODUCT_STORE_ID", nullable = true, insertable = true, updatable = true, length = 20)
    public String getProductStoreId() {
        return productStoreId;
    }

    public void setProductStoreId(String allowProductStoreChange) {
    ...
    public boolean equals(Object o) {
        ...
        if (allowProductStoreChange != null ? !allowProductStoreChange.equals(webSite.allowProductStoreChange) : webSite.allowProductStoreChange != null)
            return false;
        if (productStoreId != null ? !productStoreId.equals(webSite.productStoreId) : webSite.productStoreId != null) return false;
