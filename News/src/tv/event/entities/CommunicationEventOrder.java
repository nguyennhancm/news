 ...
 */
@Entity
@javax.persistence.Table(name = "communication_event_order")
@javax.persistence.IdClass(tv.event.entities.CommunicationEventOrderPK.class)
public class CommunicationEventOrder {
    ...
    public boolean equals(Object o) {
        ...
        CommunicationEventOrder that = (CommunicationEventOrder) o;
