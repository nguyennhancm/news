 ...
 */
@Entity
@javax.persistence.Table(name = "communication_event_type")
public class CommunicationEventType {
    private String communicationEventTypeId;

    @Id
    @javax.persistence.Column(name = "COMMUNICATION_EVENT_TYPE_ID", nullable = false, insertable = true, updatable = true, length = 20)
    ...
    public boolean equals(Object o) {
        ...
        CommunicationEventType that = (CommunicationEventType) o;
    ...
    @Override
    public int hashCode() {
        int result = communicationEventTypeId != null ? communicationEventTypeId.hashCode() : 0;
