 ...
 */
@Entity
@javax.persistence.Table(name = "comm_content_assoc_type")
public class CommContentAssocType {
    private String commContentAssocTypeId;

    @Id
    @javax.persistence.Column(name = "COMM_CONTENT_ASSOC_TYPE_ID", nullable = false, insertable = true, updatable = true, length = 20)
    ...
    public boolean equals(Object o) {
        ...
        CommContentAssocType that = (CommContentAssocType) o;
    ...
    @Override
    public int hashCode() {
        int result = commContentAssocTypeId != null ? commContentAssocTypeId.hashCode() : 0;
