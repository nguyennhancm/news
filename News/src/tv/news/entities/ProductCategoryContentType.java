 ...
 */
@Entity
@javax.persistence.Table(name = "product_category_content_type")
public class ProductCategoryContentType {
    private String prodCatContentTypeId;

    @Id
    @javax.persistence.Column(name = "PROD_CAT_CONTENT_TYPE_ID", nullable = false, insertable = true, updatable = true, length = 20)
    ...
    public boolean equals(Object o) {
        ...
        ProductCategoryContentType that = (ProductCategoryContentType) o;
        ...
        if (prodCatContentTypeId != null ? !prodCatContentTypeId.equals(that.prodCatContentTypeId) : that.prodCatContentTypeId != null)
            return false;
    ...
    @Override
    public int hashCode() {
        int result = prodCatContentTypeId != null ? prodCatContentTypeId.hashCode() : 0;
