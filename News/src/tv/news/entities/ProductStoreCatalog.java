 ...
 */
@Entity
@javax.persistence.Table(name = "product_store_catalog")
@javax.persistence.IdClass(tv.news.entities.ProductStoreCatalogPK.class)
public class ProductStoreCatalog {
    ...
    public boolean equals(Object o) {
        ...
        ProductStoreCatalog that = (ProductStoreCatalog) o;
