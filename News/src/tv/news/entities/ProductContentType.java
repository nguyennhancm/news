 ...
 */
@Entity
@javax.persistence.Table(name = "product_content_type")
public class ProductContentType {
    ...
    public boolean equals(Object o) {
        ...
        ProductContentType that = (ProductContentType) o;
    ...
    @Override
    public int hashCode() {
        int result = productContentTypeId != null ? productContentTypeId.hashCode() : 0;
