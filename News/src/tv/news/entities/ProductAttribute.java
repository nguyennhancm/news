 ...
 */
@Entity
@javax.persistence.Table(name = "product_attribute")
@javax.persistence.IdClass(tv.news.entities.ProductAttributePK.class)
public class ProductAttribute {
    ...
    @Basic
    @javax.persistence.Column(name = "ATTR_TYPE", nullable = true, insertable = true, updatable = true, length = 255)
