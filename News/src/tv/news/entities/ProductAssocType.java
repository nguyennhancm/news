 ...
 */
@Entity
@javax.persistence.Table(name = "product_assoc_type", schema = "", catalog = "ofbiz1")
public class ProductAssocType {
    ...
    public boolean equals(Object o) {
        ...
        ProductAssocType that = (ProductAssocType) o;
    ...
    @Override
    public int hashCode() {
        int result = productAssocTypeId != null ? productAssocTypeId.hashCode() : 0;
