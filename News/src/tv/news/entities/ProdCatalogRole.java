 ...
 */
@Entity
@javax.persistence.Table(name = "prod_catalog_role")
@javax.persistence.IdClass(tv.news.entities.ProdCatalogRolePK.class)
public class ProdCatalogRole {
    ...
    public boolean equals(Object o) {
        ...
        ProdCatalogRole that = (ProdCatalogRole) o;
